...
Mockup Builder is a four-agent system. Agent 1 (extraction) and Agents 2, 3 & 4 (building) are decoupled through a file-based handoff contract. Agent 4 operates independently — no extraction step required.
...
```
  ...
  from user                                 │                    + screenshots
                                            ...
                                            ▼                  ┌───────────┐
                                                     reads──▶│ Agent 3:  │
                                                               │ End-to-End│──▶ Multi-screen
                                                               │ Demo      │    demo + index
                                                               └───────────┘

  ┌───────────┐
  │ Agent 4:  │──────────────────────────────────────────────▶ HTML mockups
...
| Aspect | Agent 2: Build | Agent 4: WOW |
|--------|---------------|--------------|
...
└── mockups/                 ← Agent 2 / Agent 3 / Agent 4 output (HTML mockup files)
    ...
    ├── dashboard-wow.html       ← Agent 4: WOW mode — invented design
